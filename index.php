...
<html lang="es">
  ...
  <body>
    <div class="container text-center">
      <h1 class="title mb-4">Gimnasio Social</h1>
      <div class="button-grid">
        <button class="button bg-blue" id="accesoButton">
          <svg
        ...
        <button class="button bg-green" id="qrButton">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            alt="Generar QR"
        ...
        <button class="button bg-purple" id="registroButton">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
            alt="Registro"
    ...
    <div class="dialog-overlay" id="dialogOverlay">
      <div class="dialog animated fadeInUp" id="dialogContent">
